...
if(isset($limite)){
    /** @var \Model\Propiedad*/
    $propiedades = Propiedad::obtenerTodoConLimite($limite);    
}else{
    /** @var \Model\Propiedad*/
    $propiedades = Propiedad::obtenerTodo();
}
...
<div class="contenedor-anuncios">
    ...
    <div class="anuncio">
        <img loading="lazy" width="500" height="300"  src="<?php echo '/imagenes/'.$propiedad -> getImagen();?>" alt="Foto de la propiedad">
...
<?php mysqli_close($db); ?><!-- Cerrar conexión --> 